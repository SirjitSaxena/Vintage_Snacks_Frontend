      ...
      <form onSubmit={submitHandler} className='my-3'>
        <div className="row">
          <div className="mb-3 col-md-4">
            ...
            <input name='fullName' value={formData.fullName} onChange={onChangeHandler} type="text" className="form-control bg-dark text-light" id="exampleInputEmail1" aria-describedby="emailHelp" />
          </div>
          <div className="mb-3 col-md-4">
            <label htmlFor="exampleInputEmail1" className="form-label">Country</label>
            <input name='country' value={formData.country} onChange={onChangeHandler} type="text" className="form-control bg-dark text-light" id="exampleInputEmail" aria-describedby="emailHelp" />
          </div>
          <div className="mb-3 col-md-4">
        ...
        <div className="row">
          <div className="mb-3 col-md-4">
            ...
            <input name='city' value={formData.city} onChange={onChangeHandler} type="text" className="form-control bg-dark text-light" id="exampleInputEmail1" aria-describedby="emailHelp" />
          </div>
          <div className="mb-3 col-md-4">
            <label htmlFor="exampleInputEmail1" className="form-label">Pincode</label>
            <input name='pincode' value={formData.pincode} onChange={onChangeHandler} type="number" className="form-control bg-dark text-light" id="exampleInputEmail" aria-describedby="emailHelp" />
          </div>
          <div className="mb-3 col-md-4">
